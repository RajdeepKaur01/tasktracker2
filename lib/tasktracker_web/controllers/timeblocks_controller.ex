defmodule TasktrackerWeb.TimeblocksController do
  ...
  def delete(conn, %{"id" => id}) do
    timeblocks = Tracker.get_timeblocks!(id)
    # with {:ok, %Timeblocks{}} <- Tracker.delete_timeblocks(timeblocks) do
  ...
  def web_create(conn, %{"timeblocks" => timeblocks_params}) do
  ...
  def web_update(conn, %{"id" => id, "timeblocks" => timeblocks_params}) do
    timeblocks = Tracker.get_timeblocks!(id)
